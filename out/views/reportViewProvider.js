...
exports.ReportViewProvider = void 0;
...
class ReportViewProvider {
    ...
    excelExport;
    sidebar;
    static viewType = "copilotUsageTracker.reports";
    webviewView;
    constructor(context, tracker, storage, reporting, excelExport, sidebar) {
  ...
  <script src="${scriptUri}"></script>
    ...
    async pushBootstrapState() {
        ...
        this.webviewView.webview.postMessage({
            type: "bootstrap",
            payload: {
                defaultFrom: (0, date_1.toDayKey)(now),
                defaultTo: (0, date_1.toDayKey)(now),
                todayCount: this.reporting.getTodayCount(prompts, (0, date_1.toDayKey)(now)),
                monthCount: this.reporting.getMonthCount(prompts, (0, date_1.toMonthKey)(now)),
                recentPrompts: prompts.slice(0, 10)
            }
        });
    }
    async handleSavePrompt(message) {
    ...
    async handleGenerateReport(from, to) {
        const prompts = await this.storage.getAllPrompts();
    ...
    async handleExportReport(from, to) {
        const prompts = await this.storage.getAllPrompts();
...
exports.ReportViewProvider = ReportViewProvider;
//# sourceMappingURL=reportViewProvider.js.map